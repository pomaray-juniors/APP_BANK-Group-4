...
namespace APP_BANK.Cajero
{
    ...
    public partial class Login : Form
    {
        ...
        private void timer_Tick(object sender, EventArgs e)
        {
            ...
            {
                timer.Stop();
                pictureBox4.Location = new Point(770, 396);
        ...
        private void roundButton2_Click(object sender, EventArgs e)
        {
            ...
            var resultado = dbConnection.VerificarUsuario(tbx1.Texts, textBoxCustom2.Texts);
            ...
            else if (resultado.usuarioValido)
            {
                ...
                {
                    MostrarAlertaBien("Bienvenido");
                    
                    MessageBox.Show("Bienvenido, Bienvenido Cajero.", "Acceso Concedido", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            {
                MostrarAlertaError("DATOS iMCORRECTOS!.");
        ...
        private Point posicionOriginal = new Point( 1191, 63); // Guarda 

        private void MostrarAlertaBien(string tx)
        {

            label14.Text = tx;
            panel5.Location = new Point(830, 49);
            AlertaTime.Interval = 2000;
            AlertaTime.Start();
            
        }


        private void MostrarAlertaError(string tx)
        {
            label12.Text = tx;
            panel4.Location = new Point(820, 49);
            AlertaTime.Interval = 2000;
            
            AlertaTime.Start(); 
        }

        private void AlertaTime_Tick(object sender, EventArgs e)
        {
            panel4.Location = posicionOriginal; 
            AlertaTime.Stop(); 
        }
    }
}
